...
def install_bench(args):
	...
	extra_vars.update(get_passwords(args.run_travis or args.without_bench_setup, args.password))
	if args.production:
...
def get_passwords(ignore_prompt=False, password=None):
	if password:
		ignore_prompt=True
	...
	if not ignore_prompt:
		...
		mysql_root_password = admin_password = password or 'travis'
...
def parse_commandline_args():
	...
	parser.add_argument('--password', dest='password', help='Sets db and admin passwords')
